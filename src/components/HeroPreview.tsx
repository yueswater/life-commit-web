...
import { LayoutDashboard, Book, Target, Plus, Flame } from 'lucide-react';
          ...
          <div className="flex-grow flex flex-col gap-4">
            ...
            <div className="grid grid-cols-4 sm:grid-cols-5 gap-3">
              <div className="aspect-square rounded-2xl bg-[#eeba2c] flex flex-col items-center justify-center p-2 shadow-lg shadow-[#eeba2c]/20">
                ...
                <span className="text-[10px] font-black text-black uppercase tracking-tighter">{t('icons.book')}</span>
              </div>
              <div className="aspect-square rounded-2xl bg-[#161b22] border border-gray-800 flex flex-col items-center justify-center p-2 text-gray-500">
                ...
                <span className="text-[10px] font-black uppercase tracking-tighter">DDAD</span>
              </div>
              {[...Array(3)].map((_, i) => (
                <div key={i} className="aspect-square rounded-2xl border-2 border-dashed border-gray-800/30 flex items-center justify-center opacity-20" />
              ))}
            </div>
          </div>
        </div>
